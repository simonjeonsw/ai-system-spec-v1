...
-- stage_execution_ledger: deterministic stage attempt checkpoints
CREATE TABLE IF NOT EXISTS stage_execution_ledger (
...
CREATE UNIQUE INDEX IF NOT EXISTS stage_execution_ledger_identity_key
  ON stage_execution_ledger (video_id, run_id, stage, attempt);

CREATE INDEX IF NOT EXISTS stage_execution_ledger_video_run_idx
  ON stage_execution_ledger (video_id, run_id, created_at DESC);
