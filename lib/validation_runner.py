...
from .pipeline_profile import TOGGLE_STAGE_MAP, resolve_pipeline_profile_from_env
...
def _resolve_expected_stages(video_id: str) -> Set[str]:
    ...
    if manifest_toggles:
        ...
        _, resolved_toggles = resolve_pipeline_profile_from_env()
        for toggle_name, stage in TOGGLE_STAGE_MAP.items():
            if bool(resolved_toggles.get(toggle_name, False)):
                expected.add(stage)
